...
def googlemap_scrapper():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.get_by_role("combobox").fill('hotel near kathmandu')
            ...
            for article in articles:
                ...
                page.locator(".fontBodyMedium").first.wait_for(state='visible', timeout=10000)
                ...
                for review in review_cards:
                    try:
                        ...
                        rating_ = page.locator("xpath=.//span[contains(text(), '/5')]").first.inner_text()
                        rating = rating_[0]
            ...
            if reviews_data:
                ...
                csv_filename = 'googlemaphotel111review.csv'
